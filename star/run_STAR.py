...
def star (sample, outputdir, chimSegmentMin, read1, read2=None, index=None, **other_qsub_options):
    ...
    cmd += "--quantMode TranscriptomeSAM GeneCounts --outSAMunmapped Within --genomeSAsparseD 2 --limitBAMsortRAM  35000000000 \n"

    name = 'star_' + sample
    return qsub.qsub(name, cmd, modules=modules, other='cpu=4|mem=50gb|walltime=72:00:00',  **other_qsub_options)
